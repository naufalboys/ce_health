...
public class Camera2BasicFragment extends Fragment
  ...
  private String cameraId_this = CAMERA_FRONT;
  ...
  public View onCreateView(
    ...
    return inflater.inflate(com.computerengineeringits.ce_health.R.layout.fragment_camera2_basic, container, false);
  }

  /** Connect the buttons to their event handler. */
  @Override
  public void onViewCreated(final View view, Bundle savedInstanceState) {
    textureView = (AutoFitTextureView) view.findViewById(com.computerengineeringits.ce_health.R.id.texture);
    textView = (TextView) view.findViewById(com.computerengineeringits.ce_health.R.id.text);
    ImageView switchCameraButton = (ImageView) view.findViewById(R.id.imageViewSwitchCamera);
  ...
  private void setUpCameraOutputs(int width, int height) {
    ...
    try {
      ...
      ErrorDialog.newInstance(getString(com.computerengineeringits.ce_health.R.string.camera_error))
